...
$jumlahData = count(query("SELECT * FROM undangan"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerhalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerhalaman * $halamanAktif) - $jumlahDataPerhalaman;
// $surat = query("SELECT * FROM suratm ORDER BY id DESC");
$surat = query("SELECT * FROM undangan ORDER BY id DESC LIMIT $awalData, $jumlahDataPerhalaman");
// tombol cari di klik
				...
				<tbody>
					...
					<?php foreach ($surat as $row) : ?>
						<tr>
							...
							<a href="hapus.php?id=<?= $row['id']; ?> &surat=<?= $row['surat'] ?>" onclick="return confirm('yakin?')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-square" viewBox="0 0 16 16">
							...
							<td><a href="suratm.php?id=<?php echo $row['id'];?>"><i class="bi bi-envelope-check"></i></a></td>
						</tr>
						<?php $i++; ?>
					<?php endforeach; ?>
				</tbody>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="mb-3">
							<label for="dari" class="col-form-label">Asal Surat</label>
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="tempat" name="tempat" required="harus di isi">
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							<label for="surat" class="col-form-label">File Surat</label>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="mb-3">
							<label for="hari" class="col-form-label">Hari/Tanggal</label>
							<input type="text" class="form-control" id="hari" name="hari" value="<?= $row['hari'] ?>">
						</div>
						<div class="mb-3">
							<label for="no" class="col-form-label">Nomor Surat</label>
							<input type="text" class="form-control" id="no" name="no" value="<?= $row['no'] ?>">
						</div>
						<div class="mb-3">
							<label for="dari" class="col-form-label">Asal Surat</label>
							<input type="text" class="form-control" id="dari" name="dari" value="<?= $row['dari'] ?>">
						</div>
						<div class="mb-3">
							<label for="jadwal" class="col-form-label">Waktu</label>
							<input type="text" class="form-control" id="jadwal" name="jadwal" value="<?= $row['jadwal'] ?>">
						</div>
						<div class="mb-3">
							<label for="tempat" class="col-form-label">Tempat</label>
							<input type="text" class="form-control" id="tempat" name="tempat" value="<?= $row['tempat'] ?>" required="harus di isi">
						</div>
						<div class="mb-3">
							<label for="perihal" class="col-form-label">Perihal</label>
