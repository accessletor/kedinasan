...
$surat = query("SELECT * FROM suratm ORDER BY id DESC LIMIT $awalData, $jumlahDataPerhalaman");
// tombol cari di klik
				...
				<ul class="navbar-nav ms-auto">
					<li class="nav-item dropdown active">
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" href="">Input Surat Masuk</a></li>
							<li><hr class="dropdown-divider"></li>
							<li><a class="dropdown-item" href="disposisi.php">Disposisi Surat Masuk</a></li>
						</ul>
					</li>
					<li class="nav-item">
				...
				<tbody>
					...
					<?php foreach ($surat as $row) : ?>
						<tr>
							...
							<a href="hapus.php?id=<?= $row['id']; ?>&surat=<?= $row['surat'] ?>&disposisi=<?= $row['disposisi'] ?>" onclick="return confirm('yakin?')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-square" viewBox="0 0 16 16">
							...
							<td><?php echo date('Y-m-d', strtotime($row['tglsurat'])); ?></td>
							<td><?php echo $row['dari']; ?></td>
							<td><?php echo $row['hal']; ?></td>
							<td><a href="suratm.php?id=<?php echo $row['id'];?>"><i class="bi bi-envelope-check"></i></a>&nbsp;<a href="readDisposisi.php?id=<?php echo $row['id'];?>"><i class="bi bi-receipt"></i></a></td>
						</tr>
						<?php $i++; ?>
					<?php endforeach; ?>
				</tbody>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="mb-3">
							<label for="nodisposisi" class="col-form-label">No Disposisi</label>
							<input type="text" class="form-control" id="nodisposisi" name="nodisposisi">
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="kasie" name="kasie">
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							<label for="disposisi" class="col-form-label">File Disposisi</label>
							<input type="file" class="form-control" id="disposisi" name="disposisi">
						</div>
